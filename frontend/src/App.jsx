...
// import Chatbot from './stores/components/Chatbot'
// 
// 
// const App = () => {
//   return (
...
import RegisterPage from './stores/pages/RegisterPage';
  ...
  return (
    <div>
      <Routes>
        ...
        />
        <Route path="/login" element={<LoginPage users={users} setIsLoggedIn={setIsLoggedIn} />} />
